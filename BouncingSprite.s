...
XPOS        = $0400     ; sprite x position
YPOS        = $0401     ; sprite x position
XPOS_2      = $0404     ; sprite x position
YPOS_2      = $0405     ; sprite x position
;-------------------------------------------------------------------------------
...
RightBoundaryCheck:
        ...
        bcc UpdateHorPosition   ; if sprite 1 is two sprites-wide to the left of right boundary, no collision
            ...
            sta XPOS                ; reposition sprite 1 horizontally
            bra InvertHorSpeed      ; invert the horizontal speed
UpdateHorPosition:
        sta XPOS                ; if no collision happened, store new position
...
CheckLowerBoundary:
        ...
        bcc UpdateVerPosition
            ...
            sta YPOS                ; reposition sprite 1 horizontally
            bra InvertVerSpeed      ; invert the horizontal speed
UpdateVerPosition:
        sta YPOS                ; if no collision happened, store new position
...
UpdateOtherSprites:
        lda XPOS                ; get new horizontal position of sprite 1
        sta XPOS_2              ; update sprite 3
        clc
        adc #SPRITE_SIZE
        sta OAMMIRROR + $04     ; update sprite 2
        sta OAMMIRROR + $0c     ; update sprite 4
        ; vertical position
        lda YPOS                ; get new vertical position of sprite 1
